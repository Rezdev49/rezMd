...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
  try {
    ...
    let pp = 'https://telegra.ph/file/08a3c744d42a8b72240b6.jpg'
    ...
    await conn.send3ButtonLoc(m.chat, await (await fetch(pp)).buffer(), text.trim(), '© Whatsapp bot by @shen', 'Owner Bot', '.owner', 'Invite bot', '/sewa', 'Donasi owner', '/donasi', m)
  } catch (e) {
