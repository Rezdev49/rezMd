...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
  try {
    ...
    let pp = 'https://telegra.ph/file/a7299f041206177808953.jpg'
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch(pp)).buffer(), text.trim(), '© Whatsapp bot by @shen', 'Owner Bot', '.owner', 'Invite bot', '/sewa', m)
  } catch (e) {
